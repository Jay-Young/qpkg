...
| [VueTorrent](/vuetorrent/)                 |   2.7.3    |  原生  |                用 vue 实现的 qbittorrent webui                |
...
| [B 站录播姬](/BililiveRecorder/)           |   2.11.1   |  原生  |         一个方便好用免费开源的 mikufans 直播录制工具          |
| [cURL](/cURL/)                             |   8.4.0    |  原生  |       基于网络协议，对指定 URL 进行网络传输的命令行工具       |
| [迅雷](/xunlei-pan/)                       |   3.19.2   |  原生  |                   不用过多介绍的迅雷下载器                    |
