...
exports.authenticateOrigin = exports.ensureOrigin = exports.self = exports.getCookieOptions = exports.disposer = exports.getCookieDomain = exports.redirect = exports.constructRedirectPath = exports.relativeRoot = exports.authenticated = exports.ensureAuthenticated = exports.replaceTemplates = exports.createClientConfiguration = void 0;
...
function authenticateOrigin(req) {
    ...
    if (!host) {
        logger_1.logger.warn(`no host headers found; blocking request to ${req.originalUrl}`);
        return false;
    }
