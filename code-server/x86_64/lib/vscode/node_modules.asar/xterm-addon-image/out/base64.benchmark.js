...
const dec = new base64_wasm_1.Base64Decoder(4000000);
const RUNS = 100;
(0, xterm_benchmark_1.perfContext)('Base64', () => {
    (0, xterm_benchmark_1.perfContext)('Node - Buffer', () => {
        new xterm_benchmark_1.ThroughputRuntimeCase('decode - 256', () => {
            Buffer.from(d256, 'base64');
            return { payloadSize: d256.length };
        }, { repeat: RUNS }).showAverageThroughput();
        new xterm_benchmark_1.ThroughputRuntimeCase('decode - 4096', () => {
            Buffer.from(d4096, 'base64');
            return { payloadSize: d4096.length };
        }, { repeat: RUNS }).showAverageThroughput();
        new xterm_benchmark_1.ThroughputRuntimeCase('decode - 65536', () => {
            Buffer.from(d65536, 'base64');
            return { payloadSize: d65536.length };
        }, { repeat: RUNS }).showAverageThroughput();
        new xterm_benchmark_1.ThroughputRuntimeCase('decode - 1048576', () => {
            Buffer.from(d1M, 'base64');
            return { payloadSize: d1M.length };
        }, { repeat: RUNS }).showAverageThroughput();
    });
    (0, xterm_benchmark_1.perfContext)('Base64Decoder', () => {
        new xterm_benchmark_1.ThroughputRuntimeCase('decode - 256', () => {
            dec.init(192);
...
//# sourceMappingURL=base64.benchmark.js.map